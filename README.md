...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/symfem-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13369&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/symfem-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `symfem` can be installed with:

```
conda install symfem
```

It is possible to list all of the versions of `symfem` available on your platform with:
